...
namespace DAL
{
    ...
    partial void OnDepartmentIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PostionName", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
    ...
    partial void OnPermissionDateChanging(int value);
    partial void OnPermissionDateChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PermissionDate", DbType="Int NOT NULL")]
		public int PermissionDate
		{
			get
			{
				return this._PermissionDate;
			}
			set
			{
				if ((this._PermissionDate != value))
				{
					this.OnPermissionDateChanging(value);
					this.SendPropertyChanging();
					this._PermissionDate = value;
					this.SendPropertyChanged("PermissionDate");
					this.OnPermissionDateChanged();
				}
			}
		}
